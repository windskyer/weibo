...
def _create_zfwbtext_table(migrate_engine, drop=False):
    meta = MetaData(migrate_engine)
    meta.reflect(migrate_engine)

    # create wbtext zftables
    zfwbtext = Table('zfwbtext', meta,
...
def upgrade(migrate_engine):
    ...
    _create_zfwbtext_table(migrate_engine, drop=False)


def downgrade(migrate_engine):
    # Operations to reverse the above upgrade go here.
    _create_zfwbtext_table(migrate_engine, drop=True)
